...
```{r}
 library(readxl)
 sp100_daily_RI <- read_excel("sp100_monthly.xlsx")
   as.yearmon(sp100_daily_RI$Name)
 sp100_daily_RI
```
...
FFdownload(output_file = tempf2,tempdir = tempd2,exclude_daily = TRUE, download = TRUE, download_only=FALSE, listsave=temptxt)
load(tempf2)
ff<-FFdownload$x_Portfolios_Formed_on_BETA$monthly$value_weighted_returns
bff<-ff["2015/2019"]
bff<-timetk::tk_tbl(bff)
bff
```
